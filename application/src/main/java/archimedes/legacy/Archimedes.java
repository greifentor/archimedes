...
public class Archimedes {
	...
	public static void main(String[] args) {
		...
		String propfn = System.getProperty("archimedes.Archimedes.properties", "./archimedes.properties");
		try {
		...
		ResourceManager rm = new PropertyResourceManager(
				new PropertyFileManager().open("./conf/archimedes_resource_" + lang + ".properties"));
	...
	static {
		...
		InputStream in = Factory.getClass().getClassLoader().getResourceAsStream("dm/archimedes.ads");
		StructuredTextFile stf = new StructuredTextFile(in);
		try {
			if (in != null) {
				stf.load();
