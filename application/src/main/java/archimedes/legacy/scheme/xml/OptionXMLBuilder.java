...
/**
 * A builder for an option node of a XML representation of an Archimedes diagram. This builder will be used by numerous
 * other builders.
 *
 * @author O.Lieshoff
 *
...
public class OptionXMLBuilder extends AbstractXMLBuilder {
	...
	/**
	 * Creates a new options XML node for the passed Archimedes diagram object like a table or the diagram itself.
	 *
