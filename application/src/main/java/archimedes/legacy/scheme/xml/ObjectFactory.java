...
public interface ObjectFactory {
	 ...
	 */
	abstract public DomainModel createDomain(String name, int dataType, int length, int decimalPlace);
	 ...
	 */
	abstract public ViewModel createMainView(String name, String description, boolean showReferencedColumns);
	 ...
	 * @changed OLI 15.06.2016 - Added.
	 */
	abstract public ToStringContainerModel createToStringContainer(ColumnModel column, String prefix, String suffix);
	 ...
	 * @param defaultColor A default value which will be returned in case of no color is found for the passed name.
	 * @return The color for the passed name or the default color if no color is found for the passed name.
	 *
	 * @changed OLI 16.06.2016 - Added.
	 */
