...
public class ArchimedesOrderMetaData implements OrderMetaData {
	 ...
	 * @throws IllegalArgumentException Falls einer der Parameter als <TT>null</TT>-Referenz &uuml;bergeben wird.
	 * @precondition amd != <TT>null</TT>
	 * @precondition od != <TT>null</TT>
	 *
	 * @changed OLI 04.06.2010 - Hinzugef&uuml;gt.
	 */
	public ArchimedesOrderMetaData(AttributeMetaData amd, OrderDirection od) throws IllegalArgumentException {
		super();
		if (amd == null) {
