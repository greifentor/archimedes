...
import archimedes.legacy.grammar.cfk.ComplexForeignKeyFactory;
...
public class DataModelToMetaDataConverter {
	...
	/**
	 * Changes the table information of the data model to those of the meta data model and adds the table meta data to
	 * the meta data model.
	 *
	 * @param model  The meta data model which the table information are to add.
