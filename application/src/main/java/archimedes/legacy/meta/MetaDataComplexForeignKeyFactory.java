...
import archimedes.legacy.grammar.cfk.ComplexForeignKeyModel;
...
public class MetaDataComplexForeignKeyFactory {
	 ...
	 * @param cfk         The complex foreign key model whose data are used to create the meta data complex foreign key.
	 * @return The meta data complex foreign key for the passed complex foreign key model.
	 *
	 * @changed OLI 29.09.2017 - Added.
	 */
	public MetaDataComplexForeignKey create(String fkName, MetaDataTable sourceTable, MetaDataTable targetTable,
			ComplexForeignKeyModel cfk) {
		MetaDataComplexForeignKey mdcfk = new MetaDataComplexForeignKey(fkName, sourceTable, targetTable);
