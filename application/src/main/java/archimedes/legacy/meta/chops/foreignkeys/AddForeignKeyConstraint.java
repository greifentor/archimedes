...
public class AddForeignKeyConstraint extends AbstractForeignKeyConstraintChangeOperation {
	 ...
	 * @changed OLI 14.12.2015 - Added.
	 */
	public AddForeignKeyConstraint(MetaDataColumn column, MetaDataForeignKeyConstraint foreignKeyConstraint) {
	...
	public String toString() {
		return "AddForeignKeyConstraint(foreignKeyConstraint=\"" + this.getForeignKeyConstraint().getName()
				+ "\", column=" + this.getColumns()[0].getName() + ")";
	}
