...
public class AlterColumnDropDefault extends AbstractColumnChangeOperation {
	 ...
	 * @changed OLI 11.12.2015 - Added.
	 */
	public AlterColumnDropDefault(MetaDataTable table, MetaDataColumn column, ScriptSectionType section) {
	...
	public String toString() {
		return "AlterColumnDropDefault(table=\"" + this.getTable().getName() + "\", column=\""
