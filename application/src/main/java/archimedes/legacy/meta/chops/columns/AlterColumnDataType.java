...
public class AlterColumnDataType extends AbstractColumnChangeOperation {
	 ...
	 * @changed OLI 11.12.2015 - Added.
	 */
	public AlterColumnDataType(MetaDataTable table, MetaDataColumn column, ScriptSectionType section) {
	...
	public String toString() {
		return "AlterColumnDataType(table=\"" + this.getTable().getName() + "\", column=\"" + this.getColumn().getName()
				+ "\")";
	}
