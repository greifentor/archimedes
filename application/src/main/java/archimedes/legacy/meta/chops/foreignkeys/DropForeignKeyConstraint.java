...
public class DropForeignKeyConstraint extends AbstractForeignKeyConstraintChangeOperation {
	 ...
	 * @param foreignKeyConstraint The foreign key constraint which the change operation is to process for.
	 *
	 * @changed OLI 14.12.2015 - Added.
	 */
	public DropForeignKeyConstraint(MetaDataColumn column, MetaDataForeignKeyConstraint foreignKeyConstraint) {
	...
	public String toString() {
		return "DropForeignKeyConstraint(foreignKeyConstraint=\"" + this.getForeignKeyConstraint().getName()
