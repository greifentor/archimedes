...
public class DropMultipleForeignKeyConstraint extends AbstractChangeOperation {
	 ...
	 *
	 * @param mdcfk The foreign key constraint which the change operation is to process for.
	 *
	 * @changed OLI 29.09.2017 - Added.
	 */
	 ...
	 * @param mdcfk   The complex foreign key constraint which the change operation is to process for.
	 *
	 * @changed OLI 29.09.2017 - Added.
	 */
	public DropMultipleForeignKeyConstraint(ScriptSectionType section, MetaDataComplexForeignKey mdcfk) {
		super(section);
	...
	public String toString() {
		return "DropMultipleForeignKeyConstraint(foreignKeyConstraint=\"" + this.getComplexForeignKey().getName()
				+ "\", columns=" + this.getColumnsFullNames() + ")";
	}
