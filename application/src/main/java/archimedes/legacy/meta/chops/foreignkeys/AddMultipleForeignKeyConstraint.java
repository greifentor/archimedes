...
public class AddMultipleForeignKeyConstraint extends AbstractChangeOperation {
	 ...
	 * @param foreignKeyConstraint The complex foreign key which the change operation is to process for.
	 *
	 * @changed OLI 28.09.2017 - Added.
	 */
	 ...
	 * @changed OLI 28.09.2017 - Added.
	 */
	public AddMultipleForeignKeyConstraint(ScriptSectionType section, MetaDataComplexForeignKey foreignKeyConstraint) {
		super(section);
	...
	public String toString() {
		return "AddMultipleForeignKeyConstraint(foreignKeyConstraint=\"" + this.getComplexForeignKey().getName()
