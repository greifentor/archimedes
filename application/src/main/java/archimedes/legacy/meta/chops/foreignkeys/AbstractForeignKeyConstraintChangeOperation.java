...
public class AbstractForeignKeyConstraintChangeOperation extends AbstractChangeOperation {
	 ...
	 * @changed OLI 14.12.2015 - Added.
	 */
	public AbstractForeignKeyConstraintChangeOperation(ScriptSectionType section, MetaDataColumn column,
	 ...
	 * @changed OLI 14.12.2015 - Added.
	 */
	public AbstractForeignKeyConstraintChangeOperation(ScriptSectionType section, MetaDataColumn[] columns,
			MetaDataForeignKeyConstraint foreignKeyConstraint) {
		super(section);
		ensure(foreignKeyConstraint != null, "foreign key constraint cannot be null.");
