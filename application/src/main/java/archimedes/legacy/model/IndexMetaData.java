...
/**
 * Dieses Interface definiert die Schnittstelle eines Index-Objekte. Mit Index ist in diesem Fall ein Index auf ein Feld
 * (oder mehrere) der Datenbank gemeint.
 *
 * <P>
 * Die Implementierungen des Interfaces sollten alphabetisch nach Indexnamen sortierbar sein.
 *
 * @author O.lieshoff
 *
...
public interface IndexMetaData extends Comparable, NamedObject {
	...
	/**
	 * F&uuml;gt eine Tabellenspalte in den Index ein, die in dem Index ber&uuml;cksichtigt werden soll.
	 *
	 ...
	 * @changed OLI 14.12.2011 - Hinzugef&uuml;gt.
	 */
	abstract public void addColumn(AttributeMetaData column) throws IllegalArgumentException;
	...
	/**
	 * Pr&uuml;ft, ob die Tabellenspalte mit dem angegebenen Namen durch den Index referenziert wird.
	 *
	 * @param name Der Name der Tabellenspalte, auf die gepr&uuml;ft werden soll.
	 * @return <CODE>true</CODE>, wenn die Tabellenspalte mit dem angegebenen Namen durch den Index referenziert wird,
	 *         <CODE>false</CODE>.
	...
	/**
	 * L&oumkl;scht eine Tabellenspalte aus der Liste der f&uuml;r den Index zu ber&uuml;cksichtigenden Tabellenspalten.
	 *
	 ...
	 * @changed OLI 14.12.2011 - Hinzugef&uuml;gt.
	 */
	abstract public void removeColumn(AttributeMetaData column) throws IllegalArgumentException;
	...
	/**
	 * Setzt die angegebene Tabelle als neue Tabelle ein, f&uuml;r die der Index erzeugt werden soll.
	 *
