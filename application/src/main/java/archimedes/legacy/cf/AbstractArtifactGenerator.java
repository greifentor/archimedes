...
abstract public class AbstractArtifactGenerator<T> implements ArtifactGenerator<T> {
	 ...
	 *
	 * @param artifactBuilderFactory The artifact builder factory which the artifact generator is to build for.
	...
	@Override
	public void generate(DataModel dm, List<Artifact> artifacts, ProgressFrame progressFrame, IndividualPreferences ip,
	...
	@Override
	public void setTemporarilySuspended(boolean temporarilySuspended) {
