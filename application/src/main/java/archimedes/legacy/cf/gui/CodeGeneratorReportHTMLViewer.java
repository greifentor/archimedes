...
public class CodeGeneratorReportHTMLViewer extends JDialogWithInifile implements ActionListener {
	 ...
	 */
	public CodeGeneratorReportHTMLViewer(GUIBundle guiBundle, GenerationProcessReport report, String version) {
		this(guiBundle,
				guiBundle.getResourceText("generation.process.report.frame.title").replace("$VERSION$", version),
				report.toHTML());
	}
	...
	private JButton createButton(String name) {
		JButton button = new JButton(
				this.guiBundle.getResourceText("generation.process.report." + "frame.button." + name + ".label"));
