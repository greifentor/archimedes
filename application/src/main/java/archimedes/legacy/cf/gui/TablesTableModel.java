...
public class TablesTableModel extends AbstractSelectionManagerTableModel<TableModel> {
	...
	@Override
	public boolean isObjectSelectedWhileInitialization(TableModel object) {
		if (object.isGenerateCode() && !isTableUnselectedByStereoType(object) && !isSuppressedByOption(object)) {
			return true;
		}
		return false;
	}
