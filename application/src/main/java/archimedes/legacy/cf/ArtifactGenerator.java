...
public interface ArtifactGenerator<T> {
     ...
     * @param progressFrame A class with the frame which shows the progress of the generation
     *         process.
     * @param ip The individual preferences for the code generation process.
     * @param otgc An objects to generate collection to decide if an object is to integrate into
     *         a generation process.
     */
    abstract public void generate(DataModel dm, List<Artifact> artifacts,
    ...
    /**
     * This method should return <CODE>true</CODE> if the artifact generator creates deprecated
     * code.
     *
    ...
    /**
     * This method should return <CODE>true</CODE> if the artifact generator is suspended for
     * the current generation run.
     *
     * @return <CODE>true</CODE> if the code generated by the artifact generator is suspended
     *         for the current generation run.
     */
    abstract public boolean isTemporarilySuspended();

    /**
     * Set this flag if the artifact generator should be suspended for the current generation
     * run.
     *
     * @param temporarilySuspended Set this flag if the artifact generator should be suspended
     *         for the current generation run.
     */
