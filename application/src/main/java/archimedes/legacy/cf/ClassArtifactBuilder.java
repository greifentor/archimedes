...
abstract public class ClassArtifactBuilder<T> extends ArtifactBuilder<T> {
    ...
    private String getSourceFileName() {
        ...
        String qn = this.getPackageName().replace(".", "/") + "/" + this.getClassName()
                + ".java";
    ...
    /**
     * Returns the source of the class from head line (e. g. "public class ..." til line before
     * closing bracket.
     *
     * @return The source of the class from head line (e. g. "public class ..." til line before
     *         closing bracket.
     */
