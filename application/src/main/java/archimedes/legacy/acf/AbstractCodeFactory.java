...
import archimedes.legacy.acf.gui.CodeGeneratorListConfigurationDialog;
import archimedes.legacy.acf.gui.CodeGeneratorReportHTMLViewer;
import archimedes.legacy.acf.gui.checker.ModelCheckerMessageListFrameListener;
import archimedes.legacy.acf.gui.checker.ModelCheckerMessageListFrameModal;
import archimedes.legacy.acf.io.DefaultSourceFileReader;
import archimedes.legacy.acf.io.DefaultSourceFileWriter;
...
abstract public class AbstractCodeFactory implements CodeFactory, Runnable {
	...
	public boolean isCodeFactoryIsReadyToGenerate() {
		...
		if (messages.size() > 0) {
			...
			return d.getReturnType() == ModelCheckerMessageListFrameListener.Event.Type.GENERATE;
		}
		return true;
	}
