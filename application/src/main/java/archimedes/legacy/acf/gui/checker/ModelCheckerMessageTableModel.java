...
public class ModelCheckerMessageTableModel extends DefaultTableModel {
	...
	private static final String RES_MODEL_CHECKER_MESSAGE_TABLE_HEADLINE_CLICKABLE_TITLE = "ModelChecker.table.headline.clickable.title";
	private static final String RES_MODEL_CHECKER_MESSAGE_TABLE_HEADLINE_LEVEL_TITLE = "ModelChecker.table.headline.level.title";
	private static final String RES_MODEL_CHECKER_MESSAGE_TABLE_HEADLINE_MESSAGE_TITLE = "ModelChecker.table.headline.message.title";
	...
	public String getColumnName(int column) {
		switch (column) {
		case 0:
			return this.guiBundle.getResourceText(RES_MODEL_CHECKER_MESSAGE_TABLE_HEADLINE_LEVEL_TITLE);
		case 1:
			return this.guiBundle.getResourceText(RES_MODEL_CHECKER_MESSAGE_TABLE_HEADLINE_MESSAGE_TITLE);
		case 2:
			return this.guiBundle.getResourceText(RES_MODEL_CHECKER_MESSAGE_TABLE_HEADLINE_CLICKABLE_TITLE);
		}
		return "-";
	}
