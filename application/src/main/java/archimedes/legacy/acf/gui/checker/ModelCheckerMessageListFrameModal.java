...
public class ModelCheckerMessageListFrameModal implements ModelCheckerMessageListFrameListener, Runnable {
	...
	public ModelCheckerMessageListFrameModal(GUIBundle guiBundle, ModelCheckerMessage[] mcms,
		...
		super();
		this.frame = new ModelCheckerMessageListFrame(guiBundle, mcms, checkBeforeGenerate, listeners);
