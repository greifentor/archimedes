...
public class CodeGeneratorListTableModel extends AbstractTableModel {
	...
	private static final String[] COLUMN_HEADER_RESOURCE_NAMES = new String[] {
			"code.generators.configuration.table.column.name", "code.generators.configuration.table.column.active" };
	...
	public Object getValueAt(int row, int column) {
		...
		return this.guiBundle.getResourceText(
				"code.generators.configuration.name." + this.codeGenerators[row].getClass().getSimpleName() + ".title");
	}
...
class CodeGeneratorComparator implements Comparator<CodeGenerator> {
	 ...
	 */
	@Override
	public int compare(CodeGenerator cg0, CodeGenerator cg1) {
		String cgn0 = this.guiBundle
				.getResourceText("code.generators.configuration.name." + cg0.getClass().getSimpleName() + ".title");
		String cgn1 = this.guiBundle
				.getResourceText("code.generators.configuration.name." + cg1.getClass().getSimpleName() + ".title");
