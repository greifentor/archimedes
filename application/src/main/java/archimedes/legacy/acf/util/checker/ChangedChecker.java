...
package archimedes.legacy.acf.util.checker;
...
/**
 * A utility class which provides methods to check if a class has been changed by the generation process compared to the
 * stored file.
 *
 * @author O.Lieshoff
 *
...
public class ChangedChecker {
	...
	public static final String UNCHANGED_TEXT = "// UNCHANGED - Remove this tag and place your " + "code here.";

	/**
	 * Checks if the class stored in the file with the passed name is different to the passed source code.
	 *
	 ...
	 * @return <CODE>true</CODE> if the passed code is equal to the content of the file with the passed name.
	 *
	...
	private String changeIndividualData(String fileContent, IndividualPreferences individualPreferences) {
		...
		fileContent = fileContent.replace("@author " + userName, "@author " + individualPreferences.getUserName());
