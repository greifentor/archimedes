 ...
 * @changed OLI 18.05.2016 - Renamed to <CODE>AbstractModelChecker</CODE> and changed to an implementation of
 *          <CODE>ModelChecker</CODE>.
 */
...
abstract public class AbstractModelChecker implements ModelChecker {
	...
	/**
	 * @changed OLI 12.01.2015 - Added. /
	 * @Override public ModelCheckerMessage[] check() { // String report = ""; List<ModelCheckerMessage> l =
	 *           this.checkForMessages(); if (l.size() > 0) { report += "
	 *           <HR SIZE=3>
	 *           \n"; report += "
	 *           <H1>" + this.getReportSectionHeadline() + "</H1>\n"; report += "
	 *           <HR SIZE=1>
	 *           \n"; report += "
	 *           <P>
	 *           " + this.getReportSectionDescription() + "\n"; report += "
	 *           <UL>
	 *           \n"; for (String cn : l) { report += "
	 *           <LI>" + Str.toHTML(cn) + "</LI>\n"; } report += "
	 *           </UL>
	 *           \n"; } return report; }
	 * 
