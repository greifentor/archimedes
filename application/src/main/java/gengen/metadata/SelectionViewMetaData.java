...
/**
 * Dieses Interface umfasst die Funktionen eines SelectionViewMetaData. Hiermit k&ouml;nnen Metadaten f&uuml;r
 * Suchansichten definiert werden.
 * 
 * @author O.Lieshoff
 *
...
public interface SelectionViewMetaData {
	...
	/**
	 * Liefert die Liste der Attribute, die in der Suchansicht angezeigt werden sollen. Die Liste ist in der Reihenfolge
	 * sortiert, in der sie angezeigt werden soll.
	 *
