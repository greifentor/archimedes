...
/**
 * Implementierungen dieses Interfaces repr&auml;sentieren Objekt-Attribute eines Klassenmodells. Diese Attribute
 * enthalten alle Informationen, die zur Generierung von Businessobjekten und Persistenzschichten notwendig sind.
 *
 * @author O.Lieshoff
 *
 * @changed OLI 06.09.2009 - Hinzugef&uuml;gt
 * @changed OLI 30.09.2009 - Erweiterung um die Spezifikationen der Methoden <TT>isPrimaryKeyMember()</TT> und
 *          <TT>isTechnicalAttribute()</TT>.
...
public interface AttributeMetaData {
	 ...
	 *
	 * @return Die maximale L&auml;nge in Zeichen, die der Inhalt des Attributs annehmen darf, bzw. <TT>0</TT>, wenn die
	 *         Zeichenanzahl unbegrenzt ist.
	 *
	 ...
	 * @since 1.8.1
	 *
	 * @return Die Klasse, die durch das Attribut referenziert wird bzw. <TT>null</TT>, falls keine Klasse durch das
	 *         Attribut referenziert wird.
	 *
	 ...
	 *
	 * @return <TT>true</TT>, wenn das Attribut keinen <TT>null</TT>-Wert annehmen darf, sonst <TT>false</TT>.
	 *
	 * @changed OLI 18.11.2010 - Hinzugef&uuml;gt.
	 */
	 ...
	 *
	 * @return <TT>true</TT>, falls das Attribut Teil des Prim&auml;rschl&uuml;ssels ist, <TT>false</TT> sonst.
	 *
