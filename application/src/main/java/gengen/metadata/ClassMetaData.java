 ...
 * @changed OLI 18.09.2009 - Erweiterung um die Spezifikation der Methode <CODE>isReadyToCode()</CODE>.
 * @changed OLI 28.09.2009 - Erweiterung um die Spezifikation der Methode <CODE>getPackageName()</CODE>.
 * @changed OLI 06.10.2009 - Erweiterung um die Spezifikation der Methode <CODE>isOfStereotype(String)</CODE>.
 * @changed OLI 04.06.2010 - Erweiterung um die Spezifikation der Methode <CODE>getSelectionViewMetaData()</CODE>.
 * @changed OLI 19.10.2010 - Erweiterung um die Spezifikation der Methode <CODE>isFirstGenerationDone()</CODE>.
 * @changed OLI 20.12.2011 - Erweiterung um die Spezifikation der Methode <CODE>getAttribute(String)</CODE>.
 */
...
public interface ClassMetaData {
	 ...
	 *
	 * @param i Die Position des Attributs innerhalb der Attributliste der Klasse, das zur&uuml;ckgeliefert werden soll.
	 * @return Das Attribut an der n-ten Position der Attributliste der Klasse.
	 * @throws IndexOutOfBoundsException Falls die Position i nicht im Rahmen der Liste der Attribute der Klasse liegt.
	 */
	 ...
	 * @return Das Attribut, zum angebenen Namen oder <CODE>null</CODE>, falls es kein Attribut zum angegebenen Namen
	 *         gibt.
	 * @throws IllegalArgumentException Falls der Name, zu dem dsa Attribut ermittelt werden soll leer oder als
	 *                                  <CODE>null</CODE>-Referenz &uuml;bergeben wird.
	 */
	 ...
	 *
	 * @return <CODE>true</CODE>, wenn die Klasse bereits ihre initiale Kodierung hinter sich hat, sonst
	 *         <CODE>false</CODE>.
	 *
	 ...
	 * @return <CODE>true</CODE>, falls die Zugrh&ouml;rigkeit gegeben ist, <BR>
	 *         <CODE>false</CODE> sonst.
	 * @throws NullPointerException Falls der Stereotypenname als <CODE>null</CODE>-Referenz &uuml;bergeben wird.
