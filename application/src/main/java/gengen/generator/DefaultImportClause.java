...
/**
 * Eine Standardimplementierung f&uuml;r eine nicht statische Importklausel.
 *
 * @author O.Lieshoff
 *
...
public class DefaultImportClause extends AbstractImportClause {
	 ...
	 * @changed OLI 04.01.2011 - Hinzugef&uuml;gt.
	 */
	public DefaultImportClause(String importContent) throws IllegalArgumentException {
		super(importContent);
	}
