...
public class IndividualPreferences {
	 ...
	 * @changed OLI 18.04.2013 - Added.
	 */
	public IndividualPreferences(String baseCodePath, String companyName, String userName, String userToken) {
		super();
	 ...
	 *
	 * @param projectToken          The token of the project which the alternate base code path is to add for.
	...
	/**
	 * Returns the alternate base code path of the individual preferences for the passed project.
	 *
	 * @param projectToken The token of the project which the alternate base code path is to return for.
	 * @return An alternate base code path of the individual preferences for the passed project or the general base code
	 *         path.
	 *
	 * @changed OLI 10.07.2014 - Added.
	 */
	...
	/**
	 * Returns the all base code path of the individual preferences (separated by ";" and alternate pathes with prefix
	 * {token}+"=").
	 *
	 * @return The all base code path of the individual preferences (separated by ";" and alternate pathes with prefix
	 *         {token}+"=").
	 *
	 * @changed OLI 18.04.2013 - Added.
	 */
	...
	public String toString() {
		return "BaseCodePath=" + this.baseCodePath + ",CompanyName=" + this.companyName + ",UserName=" + this.userName
