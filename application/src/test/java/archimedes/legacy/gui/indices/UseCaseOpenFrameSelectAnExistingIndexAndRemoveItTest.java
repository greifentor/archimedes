 ...
 * selektiert einen bereits existierenden Index und l&ouml;scht diesen.
 * 
 * @author ollie
 * 
...
public class UseCaseOpenFrameSelectAnExistingIndexAndRemoveItTest {
	...
	private List<IndexMetaData> createIndexMetaDataList() {
		...
		l.add(Utils.createIndexMetaData(INDEX_NAME_0, Utils.createClassMetaDataMock(TABLE_NAME_A, this.columnA,
				this.columnB), new AttributeMetaData[] { this.columnA }));
		l.add(Utils.createIndexMetaData(INDEX_NAME_1, Utils.createClassMetaDataMock(TABLE_NAME_B, this.columnB,
				this.columnC), new AttributeMetaData[] { this.columnC }));
		return l;
	}
