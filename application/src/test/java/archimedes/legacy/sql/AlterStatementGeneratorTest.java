 ...
 * @changed OLI 17.02.2010 - Erweiterung um den Test zur Methode
 *          <TT>getAlterDataType(...)</TT>.
 * @changed OLI 09.03.2010 - Erweiterung um den Test zur Datentyp-&Auml;nderung
 *          im HSQL-Modus.
 */

public class AlterStatementGeneratorTest extends TestCase {
	...
	public void testGetAlterStatementReturnsCorrectStmtNoDomainDefaultSetCanBeNull() {
		...
		assertEquals("ALTER TABLE 'Table' ADD COLUMN 'Column' BOOLEAN DEFAULT true;", AlterStatementGenerator
				.getAlterStatement(column, DBExecMode.MYSQL, false, false, "'"));
	}
	...
	public void testGetAlterStatementReturnsCorrectStmtNoDomainDefaultSetCanNotBeNull() {
		...
		assertEquals("ALTER TABLE 'Table' ADD COLUMN 'Column' BOOLEAN NOT NULL DEFAULT true;", AlterStatementGenerator
				.getAlterStatement(column, DBExecMode.MYSQL, false, true, "'"));
	}
	...
	public void testGetAlterStatementReturnsCorrectStmtNoDomainNoDefaultCanBeNull() {
		...
		assertEquals("ALTER TABLE 'Table' ADD COLUMN 'Column' BOOLEAN;", AlterStatementGenerator.getAlterStatement(
				column, DBExecMode.MYSQL, false, false, "'"));
	}
	...
	public void testGetAlterStatementReturnsCorrectStmtNoDomainNoDefaultCanBeNullMSSQL() {
		...
		assertEquals("ALTER TABLE 'Table' ADD 'Column' BOOLEAN NOT NULL;", AlterStatementGenerator.getAlterStatement(
				column, DBExecMode.MSSQL, false, true, "'"));
	}
	...
	public void testGetAlterStatementReturnsCorrectStmtNoDomainNoDefaultCanNotBeNull() {
		...
		assertEquals("ALTER TABLE 'Table' ADD COLUMN 'Column' BOOLEAN NOT NULL;", AlterStatementGenerator
				.getAlterStatement(column, DBExecMode.MYSQL, false, true, "'"));
	}
	...
	public void testGetAlterStatementReturnsCorrectStmtStringDomainDefaultSetCanBeNullWithDomain() {
		...
		assertEquals("ALTER TABLE 'Table' ADD COLUMN 'Column' Domain DEFAULT 'true';", AlterStatementGenerator
				.getAlterStatement(column, DBExecMode.MYSQL, true, false, "'"));
	}
